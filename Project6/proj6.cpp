 ...
 * This file is a test driver for the Polymorphic classes prescribed in Project
 * 6 of CS-202
 */
...
int main() {
  ...
  cout << endl
       << "Testing VIRTUAL Move Function for DERIVED Class Objects" << endl;
  ...
  cout << endl
       << "Testing VIRTUAL Move Function on Base Class Pointers" << endl;
  for (int i = 0; i < 3; ++i) {
